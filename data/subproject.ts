...
export const subProjects: Props[] = [
  ...
  },
  {
    title: "CoinTracker",
    description:
      "React 기반으로 구축되었으며, recoil을 활용해 인터페이스 상태를 관리합니다.react-query로 실시간 데이터를 빠르게 받아오고 캐싱합니다.",
  ...
  },
  {
    title: "Planflow",
    description:
      "localStorage를 활용해 사용자 데이터를 저장하며,JavaScript의 내장 메서드로 상태를 관리하는 일정 관리 웹을 구성했습니다.",
    language: "JavaScript",
