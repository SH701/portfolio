        ...
        <div className="basis-[60%] sm:space-y-16 lg:text-xl text-sm space-y-10">
          <div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <p>어떻게 보여줄지가 아니라, 어떻게 느껴질지를 먼저 고민합니다.</p>
            </div>
          </div>
          <div>
            <h3 className="mb-3 lg:text-3xl text-2xl text-lightest-slate">
            ...
            <div className="flex flex-col gap-2">
              ...
              <p>
                작은 애니메이션 효과 하나, 상태 관리 구조 하나에도 더 나은 방향을
                계속 고민합니다.
              </p>
              <p>
                사용자가 더 편하게 느낄 수 있게 만들어낼 때 비로소 그 작업이 완성됐다고
                느낍니다.
              </p>
            </div>
          </div>
          <div>
            ...
            <div className="flex flex-col gap-2">
              <p>
                인터넷 강의를 보며 개발을 처음 접했고, 강의만 따라가는 데서 그치지 않고,
              </p>
              <p>
                배운 걸 바탕으로 혼자 힘으로 프로젝트를 만들어보며 연습했습니다.
              </p>
              <p>
                모르는 건 직접 검색하고 찾아보는 습관이 생기면서 문제도 해결할 수 있게
                됐고,
              </p>
              <p>
